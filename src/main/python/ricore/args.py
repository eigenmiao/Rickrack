...
class Args(object):
    ...
    def __init__(self, resources, resetall=False, uselang=""):
        ...
        # init settings.
        self.usr_store = os.sep.join((os.path.expanduser('~'), "Documents", "Rickrack"))
        ...
        # for choice requirement in server.
        self.sys_choice_stat = []

        # for links in board and depot view.
        self.sys_link_colors = [False, False]

        # for main and assit points in image view.
    ...
    def init_settings(self):
        ...
        if self.store_loc:
            ...
            self.usr_color = os.sep.join((os.path.expanduser('~'), "Documents", "Rickrack", "MyColors"))
    ...
    def save_settings(self):
        ...
        # saving color depot.
        # depot is stored as freestanding files.
